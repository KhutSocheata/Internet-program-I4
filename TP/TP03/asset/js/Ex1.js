var selectedRow = null;
            ...
            for (databook in dataB) {
                document.getElementById("add_items").innerHTML +=
                    `<div class="items"><img src="./asset/images/Bookpicture.jpg" alt="#"><div class="name">Name : ${dataB[databook].name}</div><div class="price">Price : ${dataB[databook].price} riels</div><div class="category">Category : ${dataB[databook].category}</div><div class="button"><button id="${parseInt(databook)}" class="editBtn" onclick="editBook(this.id)">Edit</button><button id="${parseInt(databook)}" class="deletBtn" onclick="deleteBook(this.id)">Delete</button></div></div>`;
            }
            ...
            function insertNewRecord(data) {
                ...
                document.getElementById("add_items").innerHTML +=
                    `<div class="items"><img src="./asset/images/Bookpicture.jpg" alt="#"><div class="name" data="${x}">Name : ${databooks[x].name}</div><div class="price">Price : ${databooks[x].price} riels</div><div class="category">Category : ${databooks[x].category}</div><div class="button"><button id="${parseInt(x)}" class="editBtn" onclick="editBook(this.id)">Edit</button><button id="${parseInt(x)}" class="deletBtn" onclick="deleteBook(this.id)">Delete</button></div></div>`;
            }
